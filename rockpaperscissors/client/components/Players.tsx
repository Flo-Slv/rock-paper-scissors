  ...
  return (
    <div className="text-xl flex flex-col md:flex md:flex-row md:gap-14">
      ...
      >
        ...
        <p className="mt-4 text-lg font-bold text-indigo-400">
          Score: {userScore}
        </p>

        <p className="mt-4 text-sm text-gray-300 flex justify-center">
          {userChoice === "rock" ? (
            <svg
        ...
        <p className="mt-4 text-lg text-gray-300 flex justify-center">
          {!nickName
